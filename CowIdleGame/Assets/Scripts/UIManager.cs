...
public class UIManager : MonoBehaviour
{
    ...
    // ── Prestige result ───────────────────────────────────────────────────────
    public void ShowPrestigeResult(int reward, int prestigeCount, float multiplier)
    {
        FindObjectOfType<PrestigeUIController>()?.ShowResult(reward, prestigeCount, multiplier);
    }
